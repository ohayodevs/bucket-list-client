...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://ohayo-bucketlist.herokuapp.com',
...
var todoEvents = __webpack_require__(33);
...
var signInTemplate = __webpack_require__(15);
var signUpTemplate = __webpack_require__(32);
...
var showPageOne = function showPageOne() {
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<!-- sign-in-input-form -->\n<form id=\"sign-in-form\" class=\"form-horizontal\">\n  <div class=\"form-group\">\n    <label for=\"inputEmail3\" class=\"col-sm-2 control-label\">Email</label>\n    <div class=\"col-sm-10\">\n      <input type=\"email\" class=\"form-control\" name=\"credentials[email]\" id=\"sign-in-email\" placeholder=\"Email\" required>\n    </div>\n  </div>\n  <div class=\"form-group\">\n    <label for=\"inputPassword3\" class=\"col-sm-2 control-label\">Password</label>\n    <div class=\"col-sm-10\">\n      <input type=\"password\" class=\"form-control\" name=\"credentials[password]\" id=\"sign-in-password\" placeholder=\"Password\" required>\n    </div>\n  </div>\n  <div class=\"form-group\">\n    <div class=\"col-sm-offset-2 col-sm-10\">\n      <p id=\"sign-in-feedback\"></p>\n    </div>\n  </div>\n  <div class=\"form-group\">\n    <div class=\"col-sm-offset-2 col-sm-10\">\n      <button type=\"submit\" class=\"btn btn-default\">Sign In</button>\n      <a href=\"#sign-up-form\" id=\"show-sign-up\">Sign up yet?</a>\n    </div>\n  </div>\n</form>\n<!-- end-of-sign-in-input-form -->\n";
},"useData":true});
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<!-- sign-up-form -->\n<form id=\"sign-up-form\" class=\"form-horizontal\">\n  </div>\n  <div class=\"form-group\">\n    <label for=\"inputEmail3\" class=\"col-sm-2 control-label\">Email</label>\n    <div class=\"col-sm-10\">\n      <input type=\"email\" class=\"form-control\" name=\"credentials[email]\" id=\"sign-up-email\" placeholder=\"Email\" required>\n    </div>\n  </div>\n  <div class=\"form-group\">\n    <label for=\"inputPassword3\" class=\"col-sm-2 control-label\">Password</label>\n    <div class=\"col-sm-10\">\n      <input type=\"password\" class=\"form-control\" name=\"credentials[password]\" id=\"sign-up-password\" placeholder=\"Password\" required>\n    </div>\n  </div>\n  <div class=\"form-group\">\n    <label for=\"inputPassword3\" class=\"col-sm-2 control-label\">Password</label>\n    <div class=\"col-sm-10\">\n      <input type=\"password\" class=\"form-control\" name=\"credentials[password_confirmation]\" id=\"sign-up-confirmation-password\" placeholder=\"Confirm Password\" required>\n    </div>\n  </div>\n  <div class=\"form-group\">\n    <div class=\"col-sm-offset-2 col-sm-10\">\n      <p id=\"sign-up-feedback\"></p>\n    </div>\n  </div>\n  <div class=\"form-group\">\n    <div class=\"col-sm-offset-2 col-sm-10\">\n      <button type=\"submit\" class=\"btn btn-default\">Sign Up</button>\n      <a href=\"#sign-in-form\" id=\"show-sign-in\">Already have an account? Sign In!</a>\n    </div>\n  </div>\n</form>\n<!-- end sign-up-form -->\n";
},"useData":true});
...
var onCreateTodo = function onCreateTodo(event) {
  ...
  var data = getFormFields(event.target);
  store.data = data;
  api.createTodo(data).then(ui.onCreateSuccess).then(onShowAll).catch(ui.onCreateFailure);
};

var onShowAll = function onShowAll(event) {
  $('#show-all').prop('disabled', true);
  api.showAll(event).then(ui.onShowAllSuccess).catch(ui.onShowAllFailure);
};

var onShowOne = function onShowOne(event) {
  event.preventDefault();
  var id = event.target.dataset.id;
  api.showOne(id).then(ui.onShowOneSuccess).catch(ui.onShowOneFailure);
};
var id = void 0;
...
var onUpdate = function onUpdate(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.update(data, id).then(ui.onUpdateSuccess).then(onShowAll).catch(ui.onUpdateFailure);
};
...
var onDeleteTodo = function onDeleteTodo(event) {
  event.preventDefault();
  var id = event.target.dataset.id;
  api.deleteTodo(id).then(ui.onDeleteSuccess).then($('#content').empty()).then(onShowAll).catch(ui.onDeleteFailure);
};
...
var showTodosTemplate = __webpack_require__(36);
var showTodoTemplate = __webpack_require__(37);
var showCreateTemplate = __webpack_require__(38);
var showUpdateTemplate = __webpack_require__(39);

var onShowCreateForm = function onShowCreateForm() {
  var showCreateHtml = showCreateTemplate();
...
var onShowOneSuccess = function onShowOneSuccess(data) {
  var showTodoHtml = showTodoTemplate({ todo: data.todo });
  $('#todo-content').empty();
  $('#delete-feedback').text('');
  $('#todo-content').append(showTodoHtml);
};

var onShowOneFailure = function onShowOneFailure() {
  $('#content').removeClass('text-success');
  $('#content').addClass('text-danger');
  $('#content').text('Please try again!');
};

var onShowUpdateForm = function onShowUpdateForm() {
  var showUpdateHtml = showUpdateTemplate();
  $('#todo-content').empty();
...
module.exports = {
  ...
  onShowOneSuccess: onShowOneSuccess,
  onShowOneFailure: onShowOneFailure,
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<br>\n  <div class=\"panel panel-default\" id=\"see-more-button\">\n    <div class=\"panel-heading\">\n      <h3 class=\"panel-title\" data-id="
  ...
  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.todos : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "          Location: "
    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.todo : depth0)) != null ? stack1.location : stack1), depth0))
    + "\n";
  ...
  return "  <div class=\"panel panel-default\">\n    <div class=\"panel-heading\">\n      <h3 class=\"panel-title\" data-id="
    ...
    + ">"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.todo : depth0)) != null ? stack1.name : stack1), depth0))
    + "</h3>\n    </div>\n    <div class=\"panel-body\">\n      <div>\n          Name: "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.todo : depth0)) != null ? stack1.name : stack1), depth0))
    + "\n      </div>\n      <div>\n          Description: "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.todo : depth0)) != null ? stack1.description : stack1), depth0))
    + "\n      </div>\n      <div>\n          Date: "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.todo : depth0)) != null ? stack1.date : stack1), depth0))
    + "\n      </div>\n      <div>\n"
    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = (depth0 != null ? depth0.todo : depth0)) != null ? stack1.location : stack1),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(3, data, 0),"data":data})) != null ? stack1 : "")
    + "      </div>\n      <button class=\"todo-delete btn btn-danger entry-delete-button\" class=\"entry-delete-button\" data-id="
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.todo : depth0)) != null ? stack1.id : stack1), depth0))
    + ">\n        Delete\n      </button>\n      <button type=\"button\" class=\"todo-update btn btn-info entry-update-button\" data-id="
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.todo : depth0)) != null ? stack1.id : stack1), depth0))
    + ">\n      Update\n      </button>\n\n    </div>\n  </div>\n";
},"useData":true});
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<!-- create form -->\n<p class=\"lead\">Add to Your Bucket List</p>\n<form id=\"create-form\">\n  <div class=\"form-group\">\n    <input type=\"text\" class=\"form-control\" name=\"todo[name]\" id=\"create-item\" placeholder=\"What do you want to do?\" required>\n  </div>\n  <div class=\"form-group\">\n    <input type=\"text\" class=\"form-control\" name=\"todo[description]\" id=\"create-description\" placeholder=\"Description\" required>\n  </div>\n  <div class=\"form-group\">\n    <input type=\"date\" class=\"form-control\" name=\"todo[date]\" id=\"create-date\" placeholder=\"Date\" required>\n  </div>\n  <div class=\"form-group\">\n    <input type=\"text\" class=\"form-control\" name=\"todo[location]\" id=\"create-location\" placeholder=\"Where do you want to do it?\">\n  </div>\n  <div class=\"form-group\">\n    <div class=\"col-sm-offset-2 col-sm-10\">\n      <p id=\"create-form-feedback\"></p>\n    </div>\n  </div>\n  <button type=\"submit\" class=\"btn btn-default\">Submit</button>\n</form>\n<!-- end of create form -->\n";
},"useData":true});
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<!-- update form -->\n<p class=\"lead\">Update Your Bucket List Entry</p>\n<form id=\"update-form\">\n  <div class=\"form-group\">\n    <input type=\"text\" class=\"form-control\" name=\"todo[name]\" id=\"update-item\" placeholder=\"What do you want to do?\" required>\n    <input type=\"hidden\" name=\"todo[id]\" id=\"update-form-id\">\n  </div>\n  <div class=\"form-group\">\n    <input type=\"text\" class=\"form-control\" name=\"todo[description]\" id=\"update-description\" placeholder=\"Description\" required>\n  </div>\n  <div class=\"form-group\">\n    <input type=\"date\" class=\"form-control\" name=\"todo[date]\" id=\"update-date\" placeholder=\"Date\" required>\n  </div>\n  <div class=\"form-group\">\n    <input type=\"text\" class=\"form-control\" name=\"todo[location]\" id=\"update-location\" placeholder=\"Where do you want to do it?\">\n  </div>\n  <div class=\"form-group\">\n    <div class=\"col-sm-offset-2 col-sm-10\">\n      <p id=\"update-form-feedback\"></p>\n    </div>\n  </div>\n  <button type=\"submit\" class=\"btn btn-default\">Submit</button>\n</form>\n<!-- end update form -->\n";
},"useData":true});
